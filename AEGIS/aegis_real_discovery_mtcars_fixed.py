...
# [Full engine code - same as before, but with validate_candidate patched]
# I'll provide the minimal patch and run it.

# The fix is in the validate_candidate method:
# Change the test_points from [o.x for o in val_obs] + [0.0, 1.0, -1.0]
# to just [o.x for o in val_obs].

# I'll embed the entire engine with this fix.

import math, random, copy
from dataclasses import dataclass
from typing import List, Optional, Dict, Tuple

# ... (all the same Node, evaluate, derivative, GP, etc. code as before)
# I'll include it fully to avoid any missing pieces.

# [Copied from previous script with the validation fix]
...
class AEGIS_Discovery_v8:
    ...
    def validate_candidate(self, expr_node, x_data, y_data):
        ...
        # FIX: only check actual data points, not artificial ones
...
mtcars_data = [
    (110, 21.0), (110, 21.0), (93, 22.8), (110, 21.4),
    (175, 18.7), (105, 18.1), (245, 14.3), (62, 24.4),
    (95, 22.8), (123, 19.2), (123, 17.8), (180, 16.4),
    (180, 17.3), (205, 15.2), (215, 10.4), (230, 10.4),
    (66, 14.7), (52, 32.4), (65, 30.4), (97, 33.9),
    (150, 21.5), (150, 15.5), (245, 15.2), (175, 13.3),
    (66, 19.2), (91, 27.3), (113, 26.0), (264, 30.4),
    (335, 15.8), (109, 19.7), (150, 15.0), (71, 21.4),
]
...
print("="*72)
print("AEGIS DISCOVERY – REAL DATA (mtcars) – FIXED VALIDATION")
print("="*72)
print(f"Samples: {len(x_vals)} cars")
print(f"Input: Horsepower (hp)")
print(f"Output: Miles Per Gallon (mpg)")
print("="*72)
print()
