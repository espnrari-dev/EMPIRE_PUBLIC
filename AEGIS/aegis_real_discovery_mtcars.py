...
"""
AEGIS REAL DISCOVERY – mtcars dataset (actual data)

Source: Henderson and Velleman (1981), "Building multiple regression models interactively."
Data: Motor Trend Car Road Tests (1974) – horsepower vs. miles per gallon.

This is real data, not generated. The engine will discover the relationship
...
# ============================================================
# 1. REAL DATASET (mtcars – subset)
# ============================================================

# Horsepower (x) and Miles Per Gallon (y) for 32 cars.
# These are actual measurements from the 1974 Motor Trend tests.
mtcars_data = [
    (110, 21.0),  # Mazda RX4
    (110, 21.0),  # Mazda RX4 Wag
    (93, 22.8),   # Datsun 710
    (110, 21.4),  # Hornet 4 Drive
    (175, 18.7),  # Hornet Sportabout
    (105, 18.1),  # Valiant
    (245, 14.3),  # Duster 360
    (62, 24.4),   # Merc 240D
    (95, 22.8),   # Merc 230
    ...
    (180, 16.4),  # Merc 450SE
    (180, 17.3),  # Merc 450SL
    (205, 15.2),  # Merc 450SLC
    (215, 10.4),  # Cadillac Fleetwood
    (230, 10.4),  # Lincoln Continental
    (66, 14.7),   # Chrysler Imperial
    (52, 32.4),   # Fiat 128
    (65, 30.4),   # Honda Civic
    (97, 33.9),   # Toyota Corolla
    (150, 21.5),  # Toyota Corona
    (150, 15.5),  # Dodge Challenger
    (245, 15.2),  # AMC Javelin
    (175, 13.3),  # Camaro Z28
    (66, 19.2),   # Pontiac Firebird
    (91, 27.3),   # Fiat X1-9
    (113, 26.0),  # Porsche 914-2
    (264, 30.4),  # Lotus Europa
    (335, 15.8),  # Ford Pantera L
    (109, 19.7),  # Ferrari Dino
    (150, 15.0),  # Maserati Bora
    (71, 21.4),   # Volvo 142E
]

# Separate into x and y
x_vals = [d[0] for d in mtcars_data]
y_vals = [d[1] for d in mtcars_data]

print("=" * 72)
print("AEGIS DISCOVERY – REAL DATA (mtcars)")
print("=" * 72)
print(f"Dataset: Motor Trend Car Road Tests (1974)")
print(f"Samples: {len(x_vals)} cars")
print(f"Input (x): Horsepower (hp)")
print(f"Output (y): Miles Per Gallon (mpg)")
print("=" * 72)
print()

# ============================================================
# 2. ENGINE (same as V8 – included below)
# ============================================================

# [Full engine code from V8 – embedded here for completeness]
# (I'll inline the entire engine to avoid a separate file dependency)
