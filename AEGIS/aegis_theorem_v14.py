...
"""
AEGIS‑Theorem v14 – reject any expression that simplifies to a constant.
"""
...
class GeneticProgram:
    ...
    def fitness(self, node, data_list):
        ...
        # 2. Must not simplify to a constant (i.e., no variables left)
        # If the simplified node is terminal and not a variable, it's a constant
        ...
        # 4. Novelty filter: reject trivial identity patterns
        rep = repr(simplified)
        ...
        # 5. Fitness = node_count - (variables_count * 5)
...
def main():
    print("="*72)
    print("AEGIS‑Theorem v14 – reject constant expressions")
    print("="*72)
    bounds = [3, 4, 5]
